pip install Flask requestsfrom flask import Flask, request, redirect, url_for, render_template_string
import requests
import time
...
<body>
    <header class="header">
        <h1 style="color: red;"> BHAT WASU XWD INXIDE</h1>
        <h1 style="color: blue;">WASU POST SERVER (WASU POST)</h1>
    </header>
